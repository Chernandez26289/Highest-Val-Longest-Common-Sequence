...
# In order to add new tests or change any, add them to the input directory in the format <filename>.txt
Once you run the program you will be prompted to input the file name in the format inputs/<filename>.txt
# The Written Question answers are in the PDF named "Prog Assignment 3 Questions"
Carson Hernandez - 12091173
# Program Instructions For CLion
